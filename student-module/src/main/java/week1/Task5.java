...
public class Task5 {
    public static void main(String[] args) {
        ...
        double c = (metersPerSecond *3.6);

        if(kilometersPerHour > c) {
            System.out.println("This speed is more = " + kilometersPerHour) ;
        } else {
            System.out.println("This speed is more = " + metersPerSecond);
        }
    }
}
